            ...
            <a key={service.id} href={`#${service.id}`}>
              ...
              >
                <Image
                  ...
                  alt={service.title}
                />
                <div className="absolute inset-0 ring-1 ring-white/30 dark:ring-gray-700/30 ring-inset bg-gradient-to-l from-black/80 via-black/50 to-transparent rounded-2xl overflow-hidden" />
