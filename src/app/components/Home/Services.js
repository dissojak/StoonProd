...
const Services = () => {
  return (
    <section className="bg-gray-100 dark:bg-gray-800">
      <div className="container mx-auto lg:max-w-screen-lg md:max-w-screen-sm py-20 " id="services-section">
        <div className="text-center mb-14">
          <p className="text-myRed text-lg font-normal mb-3 tracking-widest uppercase">S e r v i c e s</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 xs:gap-y-44 sm:gap-y-32 gap-x-5 xs:mt-48 sm:mt-36">
          {services.map((service, i) => (
            ...
            >
              ...
              <h3 className="text-2xl text-black dark:text-white font-semibold text-center mt-16">{service.title}</h3>
