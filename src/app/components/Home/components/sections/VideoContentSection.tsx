...
const VideoContent = () => {
  const youtubeVideoId = "yNt29Kn-wBQ";
  const youtubeVideoIdXL = "dQw4w9WgXcQ";
  const [showVideo, setShowVideo] = useState(false);
  const isMediumOrLarger = useMedia({ minWidth: 768 });
      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
        ...
        {!showVideo ? (
          <div className="relative mx-auto h-[512px]">
            ...
            />
            <div className="absolute bottom-0 left-0 right-0 top-4 -z-10 h-full w-full rounded-2xl bg-black opacity-40 dark:opacity-60"></div>
          </div>
        ) : (
          <>
            {isMediumOrLarger && (
