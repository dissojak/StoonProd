...
import { User, Lock, Eye, EyeOff, AlertCircle, Loader2, ArrowRightLeft } from "lucide-react";
    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-b from-zinc-900 to-zinc-950 p-4 sm:p-6">
      <div className="w-full max-w-md">
        <div className="mb-4 flex items-center justify-center">
          <button
            type="button"
            className="flex items-center gap-1 text-xs px-2 py-1 rounded bg-zinc-800 text-zinc-300 hover:bg-zinc-700"
