    ...
    <div className="max-w-5xl px-6 py-16 mx-auto">
      ...
      <div className="grid gap-8 mt-10 md:mt-20 md:grid-cols-2">
        <ServiceItem
          ...
          title="Commercial Video & Photography for Promotions"
          description="We provide professional video and photography services tailored to your promotional needs. From product launches to event coverage, our team captures high-impact visuals that drive engagement and elevate your brand. Whether for marketing campaigns or corporate events, we create content that boosts your visibility and connects with your audience."
        />
        <ServiceItem
          icon={
            <svg
          ...
          description="Our expertise extends to developing fully responsive and user-friendly websites that drive engagement and conversion. From custom web applications to e-commerce solutions, we deliver results."
        />
      </div>
    </div>
  </section>
