...
type PlanFeature = { id: number; text: string };
type Plan = {
  minPrice: string;
  maxPrice: string;
  title: string;
...
type ServiceData = { title: string; plans: Plan[] };

function ServiceAndTariffs() {
  const eventCoverageService: ServiceData = {
  ...
  const videoProductionService: ServiceData = {
  ...
  const webDevelopmentService: ServiceData = {
